...
To address this problem, we created a simple [Shiny](http://www.rstudio.com/shiny/) application that does the calculation for the nurses.  The nurses enter the week of gestation into the input box on the left side of the webpage (see the picture below), and the program prints the minimum number of visits they need to make on the right side of the webpage.  
